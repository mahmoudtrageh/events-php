...
<!-- start section -->
    <div class="container">
        ...
        $postBy = $_SESSION['ID'];
        $db->query("SELECT * FROM events WHERE postby='$current_user->id'");
        $events = $db->resultSet();
...
?>
    ...
    else if ($do == 'UpdateEvent')
    {
        ...
        <meta http-equiv='refresh' content='3;URL=event-dashboard.php?id=$EventId'>";
                // end of image part
    ...
    elseif ($do == 'DeleteEvent')
    {
        ...
        if ($count > 0)
        {
            ...
            <meta http-equiv='refresh' content='1;URL=event-dashboard.php?id=$EventId'>";
