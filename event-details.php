...
$db->query("SELECT firstname, lastname, id FROM users WHERE id='$organizer_id'");
$row7 = $db->single();
$count7 = $db->rowCount();
if ($count7 > 0)
{
...
?>
                ...
                <div class="pocket">
                    <h3>منظم الإيفنت</h3>
                    <ul> 
                        <li><a href="user-profile.php?id=<?php echo $row7->id ?>"> <?php echo $row7->firstname . ' ' . $row7->lastname ?></a></li>
                    </ul>
